...
export interface paths {
    "/api/v1/auth/email-action/exchange": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Exchange a Supabase email action token hash for a session */
        post: operations["AuthController_exchangeEmailAction"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/auth/password/recovery": {
        ...
        post: operations["AuthController_requestPasswordRecovery"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/auth/password/update": {
        ...
        get?: never;
        put?: never;
        /** Update the authenticated user password via Supabase Auth */
...
export interface components {
    schemas: {
        ...
        AuthMessageDto: {
            /** @example If an account exists for that email, a recovery link has been sent. */
            message: string;
        };
        AuthResultDto: {
        ...
        ExchangeEmailActionDto: {
            /** @example <token-hash-from-supabase-email-link> */
            tokenHash: string;
            /**
             * @example recovery
             * @enum {string}
             */
            type: "email" | "signup" | "recovery" | "magiclink" | "invite" | "email_change";
        };
...
export interface operations {
    AuthController_exchangeEmailAction: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ExchangeEmailActionDto"];
            };
        };
        responses: {
    ...
    AuthController_requestPasswordRecovery: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PasswordRecoveryRequestDto"];
            };
        };
        responses: {
